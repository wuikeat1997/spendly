...
- Runs as an installable mobile-friendly PWA and Capacitor shell.
...
- PWA manifest and mobile web app metadata
- Capacitor iOS and Android shells for native binary builds
...
docs/
  ...
  native-android-build.md     Capacitor Android build and release notes
...
For local and production env variables, see
[`docs/env-local-prod.md`](../docs/env-local-prod.md).
...
npm run android:sync # Sync the Capacitor Android project
npm run android:open # Open the Android project in Android Studio
```

For TestFlight/App Store or Play Store builds, sync Capacitor with the production HTTPS URL:
...
binary flow and [docs/native-android-build.md](./docs/native-android-build.md)
for the native Android flow.
...
See [docs/next-phase-product-notes.md](./docs/next-phase-product-notes.md) for the product direction and [docs/ios-release-readiness.md](./docs/ios-release-readiness.md) for mobile release checks.
